...
For v2.4.6 VCR, route-copy, phonebook, live-confidence, true-path packet, map settings, and route performance checks:
...
```powershell
.\scripts\live-smoke.ps1 -BaseUrl https://carto.canadaverse.org -ExpectedVersion 2.4.6 -ExpectedGitSha <short-sha> -DiagnoseIata YTR
```
